...
hi VertSplit    gui=NONE guifg=Gray90 guibg=Gray90
if has("gui_macvim")
...
if &background == "dark"
  ...
  hi TabLine      gui=NONE guifg=Gray40 guibg=bg
  hi TabLineFill  gui=NONE guibg=bg
  hi TabLineSel   gui=bold guifg=#FFFFFF
else
  ...
  " TabLine
  hi TabLine      gui=NONE guifg=LightGrey guibg=bg
  hi TabLineFill  gui=NONE guibg=bg
  hi TabLineSel   gui=bold guifg=DarkSlateGray
endif
