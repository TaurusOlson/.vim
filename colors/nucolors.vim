...
hi CursorLineNr              guibg=bg guifg=#A0CF5D
hi LineNr                    guifg=#665544 guibg=bg
...
" TabLine
hi TabLine     guifg=#606060 guibg=#202020 gui=none
hi TabLineSel  guifg=fg guibg=#202020
hi TabLineFill guifg=#202020 guibg=bg
...
function! InsertStatuslineColor(mode)
    if a:mode == 'i' " Insert Mode
        hi StatusLine     guifg=#E6E1DC   guibg=bg
    elseif a:mode == 'r' " Replace Mode
        hi StatusLine     guifg=#202020   guibg=#E84F4F
    else
